...
<xsl:template match="*[contains(@class, ' topic/topic ')]/*[contains(@class, ' topic/title ')]" mode="header_title">
<xsl:apply-templates/>
</xsl:template>
...
<xsl:template match="*[contains(@class, ' topic/dlentry ')]" name="topic.dlentry">
 <table width="30%;">
  <tr><td width="20%"><xsl:apply-templates select="*[contains(@class, ' topic/dt ')]"/>
  </td>
  <td width="80%"><xsl:apply-templates select="*[contains(@class, ' topic/dd ')]"/>
  </td></tr>
</table>
</xsl:template>
...
<xsl:template match="*[contains(@class, ' topic/dlhead ')]" name="topic.dlhead">
 <tr><td width="50%"><xsl:apply-templates select="*[contains(@class, ' topic/dthd ')]"/>
 </td>
  <td width="50%"><xsl:apply-templates select="*[contains(@class, ' topic/ddhd ')]"/>
  </td></tr>
</xsl:template>
...
<xsl:template name="spec-title">
 ...
 <!--<div style="margin-top: 1em;"><strong><xsl:value-of select="''"/>
 </strong>
 </div>--></xsl:if>
</xsl:template>
...
<xsl:include href="header.xsl"/>
  ...
  <xsl:template match="*" mode="addFooterToHtmlBodyElement">
    ...
    <xsl:if test="exists($footer-content)">
      <footer role="contentinfo" class="footerDiv">
