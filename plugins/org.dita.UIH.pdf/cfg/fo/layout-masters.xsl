  ...
  <xsl:template match="/" mode="create-page-masters">
    ...
    <xsl:if test="$mirror-page-margins">
      <fo:simple-page-master master-name="toc-even" xsl:use-attribute-sets="simple-page-master">
		...
		<fo:region-start region-name="even-body-start" xsl:use-attribute-sets="region-end"/>
	    <fo:region-end region-name="even-body-end" xsl:use-attribute-sets="region-start"/>
      </fo:simple-page-master>
    </xsl:if>
    ...
    <fo:simple-page-master master-name="toc-odd" xsl:use-attribute-sets="simple-page-master">
	  ...
	  <fo:region-start region-name="odd-body-start" xsl:use-attribute-sets="region-start"/>
	  <fo:region-end region-name="odd-body-end" xsl:use-attribute-sets="region-end"/>
    </fo:simple-page-master>
	...
	<fo:simple-page-master master-name="last_even" xsl:use-attribute-sets="simple-page-master">
      <fo:region-body xsl:use-attribute-sets="region-body.even"/>
      <fo:region-before region-name="even-last-body-header" xsl:use-attribute-sets="region-before"/>
      <fo:region-after region-name="even-last-body-footer" xsl:use-attribute-sets="region-after"/>
	  <fo:region-start region-name="even-body-start" xsl:use-attribute-sets="region-end"/>
	  <fo:region-end region-name="even-body-end" xsl:use-attribute-sets="region-start"/>
    </fo:simple-page-master>
	...
	<xsl:if test="$mirror-page-margins">
	<fo:simple-page-master master-name="topic-blank-page" xsl:use-attribute-sets="blank-simple-page-master">
		<fo:region-body  xsl:use-attribute-sets="region-body.even"/>
		<fo:region-before region-name="even-blank-body-header" xsl:use-attribute-sets="blank-region-before"/>
        <fo:region-after region-name="even-blank-body-footer" xsl:use-attribute-sets="region-after"/>
		<fo:region-start region-name="even-body-start" xsl:use-attribute-sets="region-end"/>
		<fo:region-end region-name="even-body-end" xsl:use-attribute-sets="region-start"/>
	</fo:simple-page-master>
	</xsl:if>
    ...
    <fo:page-sequence-master master-name="{$master-name}">
      <fo:repeatable-page-master-alternatives>
			...
			<!--<xsl:choose>
				...
				<xsl:when test="$master-reference='index'">							  
					 
				</xsl:when>	
				<xsl:otherwise>
				    <xsl:if test="$master-reference='body'">
				     <fo:conditional-page-master-reference blank-or-not-blank="blank" master-reference="last_even" odd-or-even="even" page-position="last"/>
				    </xsl:if>-->
			<fo:conditional-page-master-reference blank-or-not-blank="blank" master-reference="topic-blank-page"/>
				<!--</xsl:otherwise>
			</xsl:choose>	-->								  
      </fo:repeatable-page-master-alternatives>
